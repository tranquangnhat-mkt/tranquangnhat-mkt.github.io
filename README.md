...
- 7 case study hoàn chỉnh: Breville Christmas Challenge, SMEG Digital Brand System,
  E-commerce Growth & Marketplace Operations, B2B Event Marketing & Trade Show Activation,
  EPICURE Website Replatforming, Ông Chú Plant-Based và Saint L’Beau Creator Affiliate & Social Commerce
...
│   └── saint-lbeau-creator-affiliate-social-commerce.html
└── assets/
    ├── css/
    │   └── styles.css
    ├── js/
...
5. Commit với nội dung: `Add final Ong Chu Plant-Based and Saint LBeau case studies`.
...
Ba video của case study Saint L’Beau đã được tối ưu xuống 720p và lưu tại
`assets/videos/projects/saint-lbeau/`. Trong đó ToningMe Tea chỉ giữ hai video tiêu biểu:
`cắt trái cây` và `trà sữa`.
